...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { active: @assessment.active, created_by_id: @assessment.created_by_id, desc: @assessment.desc, name: @assessment.name } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { active: @assessment.active, created_by_id: @assessment.created_by_id, desc: @assessment.desc, name: @assessment.name } }
